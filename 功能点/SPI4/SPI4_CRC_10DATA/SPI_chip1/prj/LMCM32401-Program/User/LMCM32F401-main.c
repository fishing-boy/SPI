...
void SPI4_IRQHandler(void)
{
	...
	{
		//printf("chip1:SPI4 CRCERR TEST PASS \r\n");
...
void SPI4_MY_INIT(void)
{
  ...
  SPI4->CR1 = SPI_CR1_MSTR | SPI_CR1_BR_0 | SPI_CR1_BR_1 | SPI_CR1_BR_2 | SPI_CR1_SSM | SPI_CR1_SSI | SPI_CR1_SPE;
  SPI4->CR1 |= SPI_CR1_CRCEN;
